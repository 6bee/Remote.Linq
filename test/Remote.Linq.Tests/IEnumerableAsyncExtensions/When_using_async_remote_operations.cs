...
namespace Remote.Linq.Tests.IEnumerableAsyncExtensions
{
    ...
    public class When_using_async_remote_operations
    {
        ...
        {
            var exception = await Should.ThrowAsync<InvalidOperationException>(() => _queryable.ToListAsync());
            exception.Message.ShouldBe("The provider for the source IQueryable doesn't implement IAsyncRemoteQueryProvider. Only providers that implement IAsyncRemoteQueryProvider can be used for Remote Linq asynchronous operations.");
        }
        ...
        public async Task Should_throw_with_non_async_remote_queriable()
        {
            ...
            var exception = await Should.ThrowAsync<InvalidOperationException>(() => remoteQueryable.ToListAsync());
            exception.Message.ShouldBe("The provider for the source IQueryable doesn't implement IAsyncRemoteQueryProvider. Only providers that implement IAsyncRemoteQueryProvider can be used for Remote Linq asynchronous operations.");
        }
        ...
        public async Task Should_execute_async_remote_queriable()
        {
            ...
            var result = await remoteAsyncQueryable.ToListAsync();
        ...
        {
            var exception = await Should.ThrowAsync<InvalidOperationException>(() => _queryable.AverageAsync());
            exception.Message.ShouldBe("The provider for the source IQueryable doesn't implement IAsyncRemoteQueryProvider. Only providers that implement IAsyncRemoteQueryProvider can be used for Remote Linq asynchronous operations.");
        }
        ...
        public async Task Should_throw_with_non_async_remote_queriable_scalar()
        {
            ...
            var exception = await Should.ThrowAsync<InvalidOperationException>(() => remoteQueryable.AverageAsync());
            exception.Message.ShouldBe("The provider for the source IQueryable doesn't implement IAsyncRemoteQueryProvider. Only providers that implement IAsyncRemoteQueryProvider can be used for Remote Linq asynchronous operations.");
        }
        ...
        public async Task Should_execute_async_remote_queriable_scalar()
        {
            ...
            var result = await remoteAsyncQueryable.AverageAsync();
