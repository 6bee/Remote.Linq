...
namespace Remote.Linq.Tests.Serialization.Expressions
{
    ...
    {
        public class With_binary_formatter : When_using_LoopExpressions
        {
        ...
        public class With_data_contract_serializer : When_using_LoopExpressions
        {
        ...
        public class With_newtonsoft_json_serializer : When_using_LoopExpressions
        {
        ...
        public class With_system_text_json_serializer : When_using_LoopExpressions
        {
...
#if NETFRAMEWORK
        public class With_net_data_contract_serializer : When_using_LoopExpressions
        {
        ...
        public class With_xml_serializer : When_using_LoopExpressions
        {
