...
public abstract class When_using_simple_bool_expression
{
    ...
    public class With_protobuf_serializer() : When_using_simple_bool_expression(ProtobufSerializationHelper.Clone);

    public class With_messagepack_serializer() : When_using_simple_bool_expression(MessagePackSerializationHelper.Clone);
