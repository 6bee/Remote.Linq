...
public abstract class When_serializing_BlockExpression
{
    public class With_data_contract_serializer() : When_serializing_BlockExpression(DataContractSerializationHelper.CloneExpression);

    public class With_newtonsoft_json_serializer() : When_serializing_BlockExpression(NewtonsoftJsonSerializationHelper.Clone);

    public class With_system_text_json_serializer() : When_serializing_BlockExpression(SystemTextJsonSerializationHelper.Clone);

    public class With_protobuf_serializer() : When_serializing_BlockExpression(ProtobufSerializationHelper.Clone);

    public class With_messagepack_serializer() : When_serializing_BlockExpression(MessagePackSerializationHelper.Clone);

    public class With_xml_serializer() : When_serializing_BlockExpression(XmlSerializationHelper.CloneExpression);

#if NETFRAMEWORK
    public class With_binary_formatter() : When_serializing_BlockExpression(BinarySerializationHelper.Clone);

    public class With_net_data_contract_serializer() : When_serializing_BlockExpression(NetDataContractSerializationHelper.Clone);
#endif // NETFRAMEWORK
    ...
    protected When_serializing_BlockExpression(Func<RemoteLambdaExpression, RemoteLambdaExpression> serialize)
    {
