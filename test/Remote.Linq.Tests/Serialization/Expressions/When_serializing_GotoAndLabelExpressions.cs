...
public abstract class When_serializing_GotoAndLabelExpressions
{
    public class With_data_contract_serializer() : When_serializing_GotoAndLabelExpressions(DataContractSerializationHelper.CloneExpression);

    public class With_newtonsoft_json_serializer() : When_serializing_GotoAndLabelExpressions(NewtonsoftJsonSerializationHelper.Clone);

    public class With_system_text_json_serializer() : When_serializing_GotoAndLabelExpressions(SystemTextJsonSerializationHelper.Clone);

    public class With_protobuf_serializer() : When_serializing_GotoAndLabelExpressions(ProtobufSerializationHelper.Clone);

    public class With_messagepack_serializer() : When_serializing_GotoAndLabelExpressions(MessagePackSerializationHelper.Clone);

    public class With_xml_serializer() : When_serializing_GotoAndLabelExpressions(XmlSerializationHelper.CloneExpression);

#if NETFRAMEWORK
    public class With_binary_formatter() : When_serializing_GotoAndLabelExpressions(BinarySerializationHelper.Clone);

    public class With_net_data_contract_serializer() : When_serializing_GotoAndLabelExpressions(NetDataContractSerializationHelper.Clone);
#endif // NETFRAMEWORK
    ...
    protected When_serializing_GotoAndLabelExpressions(Func<RemoteLambdaExpression, RemoteLambdaExpression> serialize)
    {
