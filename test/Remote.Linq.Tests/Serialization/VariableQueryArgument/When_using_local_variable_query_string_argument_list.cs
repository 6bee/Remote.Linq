...
public abstract class When_using_local_variable_query_string_argument_list
{
    ...
    public class With_protobuf_serializer() : When_using_local_variable_query_string_argument_list(ProtobufSerializationHelper.Clone);

    public class With_messagepack_serializer() : When_using_local_variable_query_string_argument_list(MessagePackSerializationHelper.Clone);
