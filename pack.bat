...
clean ^
  ...
  && dotnet test test\Remote.Linq.Extensions.Include.Tests  --configuration %configuration% ^
  ...
  && dotnet pack src\Remote.Linq.Extensions.Include         --configuration %configuration% ^
