...
namespace Remote.Linq
{
    ...
    {
        internal RemoteQueryable(Func<Expressions.Expression, IEnumerable<DynamicObject>> dataProvider, ITypeResolver typeResolver, Func<IDynamicObjectMapper> mapper)
