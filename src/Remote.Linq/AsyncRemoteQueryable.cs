...
namespace Remote.Linq
{
    ...
    public static class AsyncRemoteQueryable
    {
        ...
        /// </summary>
        [Obsolete("This method will be removed in future versions. Use Remote.Linq.RemoteQueryable.Factory.CreateAsyncQueryable() instead.", false)]
        ...
        [Obsolete("This method will be removed in future versions. Use Remote.Linq.RemoteQueryable.Factory.CreateAsyncQueryable<T>() instead.", false)]
        ...
        [Obsolete("This method will be removed in future versions. Use Remote.Linq.RemoteQueryable.Factory.CreateAsyncQueryable<TSource>() instead.", false)]
        ...
        /// <typeparam name="T">Element type of the <see cref="IQueryable{T}"/>.</typeparam>
        /// <typeparam name="TSource">Data type served by the data provider.</typeparam>
        [Obsolete("This method will be removed in future versions. Use Remote.Linq.RemoteQueryable.Factory.CreateAsyncQueryable<T, TSource>() instead.", false)]
