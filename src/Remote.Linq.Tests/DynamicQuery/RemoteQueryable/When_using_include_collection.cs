...
namespace Remote.Linq.Tests.DynamicQuery.RemoteQueryable
{
    ...
    public class When_using_include_collection
    {
        class Child
        {
        ...
        {
            expression.ShouldBeInstanceOf<MethodCallExpression>();
        }
        ...
        public void First_argument_should_be_constant_expression_with_resource_descriptor()
        {
            ...
            ((ConstantExpression)arg).Value.ShouldBeInstanceOf<QueryableResourceDescriptor>();
