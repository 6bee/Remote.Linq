...
public static class ExpressionExtensions
{
    ...
    public static AsyncDefaultExpressionExecutionContext EntityFrameworkCoreExecutor(
        ...
        => new(new DefaultEntityFrameworkCoreExpressionExecutor(dbContext, context, setTypeInformation), expression);
    ...
    public static AsyncDefaultExpressionExecutionContext EntityFrameworkCoreExecutor(
        ...
        IExpressionFromRemoteLinqContext? context = null,
        Func<Type, bool>? setTypeInformation = null)
        => new(new DefaultEntityFrameworkCoreExpressionExecutor(queryableProvider, context, setTypeInformation), expression);
    ...
    public static AsyncExpressionExecutionContext<TResult> EntityFrameworkCoreExecutor<TResult>(
        ...
        DbContext dbContext,
        IExpressionFromRemoteLinqContext? context = null)
        => new(new CastingEntityFrameworkCoreExpressionExecutor<TResult>(dbContext, context), expression);
    ...
    public static AsyncExpressionExecutionContext<TResult> EntityFrameworkCoreExecutor<TResult>(
        ...
        Func<Type, IQueryable> queryableProvider,
        IExpressionFromRemoteLinqContext? context = null)
        => new(new CastingEntityFrameworkCoreExpressionExecutor<TResult>(queryableProvider, context), expression);
